(function(){
  ...
  function importReviewPayload({ source, proposedType, proposedData, notes, documentId, submittedBy, normalizeType }){ return { document_id:documentId || null, submitted_by:submittedBy || null, source:source || "manual", proposed_record_type:normalizeType(proposedType), proposed_data:proposedData || {}, status:"needs_review", notes:notes || null }; }
